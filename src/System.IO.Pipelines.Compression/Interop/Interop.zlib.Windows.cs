    ...
    internal static partial class Interop
    {
        ...
        internal static partial class zlib
        {
            ...
            */
            ...
            private static readonly byte[] ZLibVersion = new byte[]
                {(byte) '1', (byte) '.', (byte) '2', (byte) '.', (byte) '3', 0};

            [DllImport(Libraries.Zlib)]
            private extern unsafe static int deflateInit2_(byte* stream, int level, int method, int windowBits,
            ...
            internal static unsafe ZLibNative.ErrorCode Inflate(ref ZLibNative.ZStream stream,
                ZLibNative.FlushCode flush)
            {
                fixed (ZLibNative.ZStream* streamBytes = &stream)
                {
